...
public class AuctionSniperTest {
	...
	private static final BidItem BID_ITEM
		= new BidItem(ITEM_ID, 1234);
	...
	private final AuctionSniper sniper
		= new AuctionSniper(BID_ITEM, auction);
	...
	reportsFailedIfAuctionFailsImmediately() {
		...
		context.checking(new Expectations() {{
			...
			atLeast(1).of(sniperListener).sniperStateChanged(
				SniperSnapshot.joining(ITEM_ID).failed());
	    }});
	...
	private void
	expectSniperToFailWhenItIs(final String state) {
